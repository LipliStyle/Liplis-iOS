...
class ViewWidgetCtrl :  UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    */
    func initView()
    {
        ...
        tblSetting.registerClass(CtvCellWidgetCtrlDelWidget.self, forCellReuseIdentifier: "CtvCellWidgetCtrlDelWidget")
        tblSetting.registerClass(CtvCellWidgetCtrlRescueWIdget.self, forCellReuseIdentifier: "CtvCellWidgetCtrlRescueWIdget")
        
        self.view.addSubview(tblSetting)
        
        //テーブルビューアイテム作成
        tblItems = Array<MsgSettingViewCell>()
        tblItems.append(MsgSettingViewCell(title: "全ウィジェット削除",content: "",partsType: PARTS_TYPE_TITLE,settingIdx: -1,initValue : 0, trueValue: 0, rowHeight: CGFloat(26)))
        tblItems.append(MsgSettingViewCell(title: "",content: "",partsType: 1,settingIdx: -1,initValue : 0, trueValue: 0, rowHeight: CGFloat(100)))
        tblItems.append(MsgSettingViewCell(title: "ウィジェットの画面復帰",content: "",partsType: PARTS_TYPE_TITLE,settingIdx: -1,initValue : 0, trueValue: 0, rowHeight: CGFloat(26)))
